...
$center = escape_js(txpspecialchars($center));
$loc1 = escape_js(txpspecialchars($loc1));
$loc2 = escape_js(txpspecialchars($loc2));
$heading1 = escape_js(txpspecialchars($heading1));
$heading2 = escape_js(txpspecialchars($heading2));
$bodycontent1 = escape_js(txpspecialchars($bodycontent1));
$bodycontent2 = escape_js(txpspecialchars($bodycontent2));
